...
public class BlankPlotChart extends JComponent {
    ...
    private transient NiceScale niceScale;
    private double maxValues;
    private double minValues;
    private int labelCount;
    private String valuesFormat = "#,##0.##";
    private transient BlankPlotChatRender blankPlotChatRender;
    ...
    private void createLabelText(Graphics2D g2) {
        if (labelCount > 0) {
            ...
            double locationText = (double) getHeight() - (double)insets.bottom;
            FontMetrics ft = g2.getFontMetrics();
